...
const ORB_SHELL_RADIUS := 0.45
const ORB_SHELL_HEIGHT := 0.90
const ORB_CORE_RADIUS := 0.26
const ORB_CORE_HEIGHT := 0.52
...
static func get_highlight_forward_mesh() -> BoxMesh:
	...
	_highlight_forward_mesh.size = Vector3(0.24, 0.08, 0.98)
	return _highlight_forward_mesh
...
static func get_highlight_cross_mesh() -> BoxMesh:
	...
	_highlight_cross_mesh.size = Vector3(0.98, 0.08, 0.24)
	return _highlight_cross_mesh
